  ...
  return (
    <div className="flex flex-row justify-around items-center">
      ...
      <div className="h-full w-5/6  flex flex-col md:flex-col lg:flex-row">
        <div className="w-full md:width-full lg:w-1/3 lg:rounded-l-lg bg-slate-100 flex flex-row px-5 py-5 gap-x-5 border border-solid border-gray-500">
          <div className="flex flex-col justify-start ">
            <img
              className="h-28 w-28 rounded-full border border-solid border-gray-500 object-cover"
              src={`http://localhost:3009/assets/${doctors[currentIndex].image}`}
          ...
          <div className="flex flex-col items-start ">
            ...
            <div className="flex flex-row items-center pb-3 justify-start">
              <FontAwesomeIcon
                className="text-md text-gray-500 mr-1"
                icon={faCircleDot}
              ></FontAwesomeIcon>{" "}
            ...
            <div className="flex flex-row items-center pb-3">
              ...
              <p className="text-md text-gray-500">
                {" "}
                Hospital: {doctors[currentIndex].hospital}
              </p>
            </div>
            <div
        ...
        <div className="w-full md:w-full lg:w-2/3 justify-between bg-white px-10 py-5 flex flex-col lg:rounded-r-lg border border-solid border-t-gray-400 border-r-gray-400 border-b-gray-400">
          <div className="flex flex-col">
            <div className="flex flex-row justify-between">
              <p className="text-xl  text-gray-500"> Date</p>
              <p className="text-lg  text-gray-500"> Available Times</p>
            </div>

            <div className="h-0.5 my-3 w-full bg-slate-600"></div>
            <div className="flex flex-row justify-between">
